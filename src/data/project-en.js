...
export const enProjects = [
  {
    ...
    body: `
      ...
      <p class="mb-4">
        The Cambodian real estate market is often fragmented, making it difficult for agents to manage listings and for buyers to find verified properties. Our goal was to build a centralized, "One-Stop" platform that streamlines these operations with a modern user experience.
      </p>

      <h3 class="text-xl font-bold mb-2">The Solution</h3>
      <p class="mb-4">
        We developed a comprehensive ecosystem consisting of three parts: a <strong>Customer Website</strong> for searching properties, a <strong>Mobile App</strong> for on-the-go access, and a robust <strong>Admin Dashboard</strong> for agencies to manage content.
      </p>

      <h3 class="text-xl font-bold mb-2">Key Features</h3>
      <ul class="list-disc pl-5 mb-4 space-y-1">
        <li><strong>Advanced Search & Filter:</strong> Real-time filtering by location, price, and property type.</li>
        <li><strong>Security:</strong> Secure login system using OTP (Twilio) and role-based access.</li>
        <li><strong>Admin Backoffice:</strong> A Filament-based dashboard for approving listings and managing users.</li>
        <li><strong>Cross-Platform Sync:</strong> Data is synchronized instantly between the web and Flutter mobile app.</li>
      </ul>

      <h3 class="text-xl font-bold mb-2">My Role</h3>
      <p>
        As the <strong>Web Developer</strong> in a team of 7, I was responsible for building the frontend user interface using React and integrating it with the Laravel API.
      </p>
    `,
  ...
  }, 
  {
    ...
    subtitle: "Custom-built SME Solution | GIZ-ICONE",
    body: `
      <h3 class="text-xl font-bold mb-2">The Challenge</h3>
      <p class="mb-4">
        Small and Medium Enterprises (SMEs) in Cambodia, such as <strong>Toeuk Somrong</strong>, often struggle with complex, English-only ERP software. They needed a localized, easy-to-use system to manage their production lines and stock.
      </p>

      <h3 class="text-xl font-bold mb-2">The Solution</h3>
      <p class="mb-4">
        Under the GIZ-ICONE program, I led the development of a fully <strong>Khmer-language</strong> Inventory and Production Management System. It replaces manual paperwork with a digital workflow tailored specifically for local manufacturing processes.
      </p>

      <h3 class="text-xl font-bold mb-2">Key Features</h3>
      <ul class="list-disc pl-5 mb-4 space-y-1">
        <li><strong>Inventory Tracking:</strong> Real-time monitoring of raw materials and finished goods.</li>
        <li><strong>Telegram Integration:</strong> An automated bot sends instant alerts for low stock and new orders.</li>
        <li><strong>Localization:</strong> 100% Khmer language interface for accessibility.</li>
        <li><strong>Reporting:</strong> One-click export of sales and production reports (Excel/PDF).</li>
      </ul>

      <h3 class="text-xl font-bold mb-2">My Role</h3>
      <p>
        <strong>Lead Fullstack Developer.</strong> I architected the database, built the Laravel backend, developed the React frontend, and conducted training sessions for the business owners.
      </p>
    `,
    tags: ["React", "Laravel", "Freelance", "SMEs", "GIZ-ICONE"],
    images: [
      "/projects/inventory/inventory-thumbnail.png",
      "/projects/inventory/inventory-1.png",
      "/projects/inventory/inventory-2.png",
  ...
  {
    id: 3,
    title: "Schoolio Book Sharing",
    subtitle: "Community-Driven Book Sharing Platform",
    body: `
      <h3 class="text-xl font-bold mb-2">The Concept</h3>
      <p class="mb-4">
        Schoolio is designed to foster a global reading community. It addresses the difficulty of finding specific academic and leisure books by allowing users to share their digital libraries with one another.
      </p>

      <h3 class="text-xl font-bold mb-2">Core Functionality</h3>
      <p class="mb-4">
        Unlike standard libraries, Schoolio is <strong>community-driven</strong>. Users can upload their own books, download resources from others, and curate their own reading profiles.
      </p>

      <h3 class="text-xl font-bold mb-2">Key Features</h3>
      <ul class="list-disc pl-5 mb-4 space-y-1">
        <li><strong>Cloud Storage:</strong> Books are securely stored and retrieved using Firebase Cloud Firestore.</li>
        <li><strong>Social Features:</strong> Users can build profiles, track reading history, and bookmark favorites.</li>
        <li><strong>Easy Access:</strong> Google OAuth 2.0 integration for one-click login.</li>
        <li><strong>Performance:</strong> Built with React and Redux Toolkit for a fast, single-page application experience.</li>
      </ul>

      <h3 class="text-xl font-bold mb-2">Tech Stack Highlight</h3>
      <p>
        This project utilizes a <strong>Serverless architecture</strong> via Firebase, reducing maintenance costs while ensuring high scalability for file storage.
      </p>
      
      <p class="mt-4">
        <strong>Live Demo:</strong> <a href="https://schoolio.vercel.app" class="text-blue-600 hover:underline" target="_blank">schoolio.vercel.app</a>
      </p>
    `,
